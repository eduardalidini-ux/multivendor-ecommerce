...
class SiteBranding(models.Model):
    admin_site_title = models.CharField(max_length=100, blank=True, default="")
    admin_site_header = models.CharField(max_length=100, blank=True, default="")
    admin_logo = models.ImageField(upload_to="branding/", blank=True, null=True)
